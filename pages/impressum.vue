<template>
  <div class="container mt-8 text-center">
    <!--Heading-->
    <h1 class="text-5xl sm:text-6xl md:text-6xl lg:text-6xl xl:text-6xl z-10 font-heading">Impressum</h1>
    ...
    <div class="font-body text-gray-700">
      ...
      <h2 class="font-bold text-2xl mt-8">Kontakt</h2>
      <p>Telefon: 0176/56951313<br/>
        E-Mail: trageberatung-lisareif@gmx.de</p>

      <h2 class="font-bold text-2xl mt-8">Streitschlichtung</h2>
      ...
      <h3 class="font-bold text-2xl mt-8">Haftung f&uuml;r Inhalte</h3>
